      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text("211134"),
            Text("Luis Humberto Escobar Gutierrez "),
            SizedBox(height: 20),
            Row(
              ...
              children: [
                IconButton(
                  ...
                  iconSize: 30,
                  onPressed: () async {
                    final call = Uri.parse('tel:+529673447288');
                ...
                IconButton(
                  icon: Icon(Icons.message, color: Color.fromARGB(255, 6, 253, 27)),
                  iconSize: 30,
                  onPressed: () async {
                    final sms = Uri.parse('sms:9614483587');
